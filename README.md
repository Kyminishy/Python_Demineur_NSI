...
- `demineur.py` — script principal du jeu

- `.gitignore` — ignore les fichiers cache Python et environnements virtuels pour Git

- `requirements.txt` — liste des dépendances pour ce projet
